                ...
                projects.map((project, i) => {
                  return (
                    <tr key={project.name} style={{ height: "auto" }}>
                      <td className="w3-mobile w3-white w3-card w3-padding-large"
                      ...
                      <td className="w3-media w3-rest w3-white w3-card picture-frame"
                        style={{ width:"50%", backgroundImage: `url(${projectProfiles[i]})` }}>
                        woah
                      {/* {
